...
def main():
    ...
    print("1 - Запросить токены через Web3")
    print("2 - Проверить баланс USSRToken")
    print("3 - Минт NFT через Web3")
    print("4 - Стейкать токены")
    print("5 - Получить награду (Claim)")
    ...
    if choice == "1":
        ...
        amount = input("Введите количество токенов для стейкинга: ")
        data = {
